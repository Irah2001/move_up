// lib/screens/training_journal_page.dart
import 'package:flutter/material.dart';
import 'package:move_up/constants/profile_theme.dart';

class TrainingJournalPage extends StatelessWidget {
  const TrainingJournalPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Journal d\'Entraînement', style: TextStyle(color: Colors.white)),
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            const Expanded(child: Center(child: Text('Journal d\'entraînement — aucune séance disponible pour le moment', style: TextStyle(color: Colors.white70, fontSize: 16), textAlign: TextAlign.center))),
            Padding(
